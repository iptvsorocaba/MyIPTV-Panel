<?php
//***********************************************************************************************************************************//
Config::set('site_name', 'IPTV+');						//Set the name you want for your Panel
Config::set('base_url', '/IPTV+/');					//Set the Folder where the panel will be installed (in this example /var/www/myiptv/)
...
//***********************************************************************************************************************************//
Config::set('stream_svr_url', 'http://192.99.245.237');		// Set the panel url, should be replaced by your ddns --> 'http://ddns'
